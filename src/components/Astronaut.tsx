...
export function Astronaut(props: JSX.IntrinsicElements['group']) {
    ...
    ) as unknown as AstronautGLTFResult
...
//         group.current.position.y = ySpring.get() + Math.sin(t * 10) * 0.02
//         group.current.rotation.x = Math.sin(t * 15) * 0.02
//         group.current.rotation.y = Math.cos(t * 12) * 0.02
//     })
